...
import com.hospital.his.client.PacsInternalImagingClient;
...
public class PatientExamSnapshotService {
    ...
    private final PacsInternalImagingClient pacsInternalImagingClient;
    ...
    public void streamSnapshot(Long checkRequestId, String plane, HttpServletResponse response) throws Exception {
        ...
        byte[] png = pacsInternalImagingClient.fetchReportSnapshot(checkRequestId, normalizedPlane);
