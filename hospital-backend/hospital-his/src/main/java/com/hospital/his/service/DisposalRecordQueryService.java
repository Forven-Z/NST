...
public class DisposalRecordQueryService {
    ...
    public Map<String, Object> getDisposalRecordForDoctor(Long disposalRequestId, Long doctorId) {
        Map<String, Object> context = disposalRequestRepository.findDisposalRecordContextByDoctor(
                        disposalRequestId, doctorId)
