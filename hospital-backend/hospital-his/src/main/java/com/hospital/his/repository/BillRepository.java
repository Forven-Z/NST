...
public class BillRepository {
    ...
    public long insertBill(String billNo, Long patientId, Long registerId, String bizType, Long bizId,
                           String billTitle, BigDecimal amount) {
        KeyHolder keyHolder = new GeneratedKeyHolder();
        jdbcClient.sql("""
                        INSERT INTO bill (bill_no, patient_id, register_id, biz_type, biz_id, bill_title, amount, status)
                        VALUES (:billNo, :patientId, :registerId, :bizType, :bizId, :billTitle, :amount, 0)
                        """)
                .param("billNo", billNo)
    ...
    public List<Map<String, Object>> findPendingByPatient(Long patientId) {
        return jdbcClient.sql("""
                        SELECT id, bill_no, biz_type, biz_id, bill_title, amount, status, register_id, create_time
                        FROM bill
                ...
                .query((rs, rowNum) -> {
                    ...
                    row.put("billNo", rs.getString("bill_no"));
    ...
    public List<Map<String, Object>> findByIdsForPatient(List<Long> billIds, Long patientId) {
        ...
        return jdbcClient.sql("""
                        SELECT id, bill_no, patient_id, register_id, biz_type, biz_id, bill_title, amount, status
                        FROM bill
    ...
    public List<Map<String, Object>> findByPatientId(Long patientId, Integer status) {
        return jdbcClient.sql("""
                        SELECT id, bill_no, biz_type, biz_id, bill_title, amount, status, register_id, create_time, paid_time
                        FROM bill
