...
import com.hospital.his.repository.InspectionResultItemRepository;
...
public class LabReportQueryService {
    ...
    public Map<String, Object> getLabReportForDoctor(Long inspectionRequestId, Long doctorId) {
        Map<String, Object> context = inspectionRequestRepository.findLabReportContextByDoctor(
                        inspectionRequestId, doctorId)
